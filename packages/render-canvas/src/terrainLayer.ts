...
import { isFrozenLake, isSnowCell } from "@fardvag/world-gen";
import {
  ALPHA,
  WORLD_RGB,
  capToBiomePalette,
...
import { clamp, coordsOf, forEachNeighbor, indexOf } from "@fardvag/shared/utils";
...
export function drawTerrainRaster(ctx, world, viewport, options: TerrainRenderOptions = {}) {
...
export function drawTerrainTextures(ctx, world, viewport, options: TerrainRenderOptions = {}) {
  const showSnow = options.showSnow !== false;
